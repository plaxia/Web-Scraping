...
$sql="INSERT INTO `trendyol` (`marka_model`, `modelno`, `islemcitipi`, `islemcinesli`, `disk_turu`, `bellek`, `ram`, `ekran_boyutu`, `isletim_sistemi`, `fiyat`,`site`,`link`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?, ?);";
    $dizi=[
    $_POST["mrk"],
    $_POST["mdl"],
    $_POST["tip"],
 ...
 <body>
 	...
 	<form action="trendyolekle.php" method="post">
